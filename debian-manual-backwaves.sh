sudo apt update && sudo apt install -y kexec-tools wget \
  ...
  && sudo /sbin/kexec -l /tmp/linux --initrd=/tmp/initrd.gz --append="\
    ...
    netcfg/get_ipaddress=157.254.51.251 \
    netcfg/get_netmask=255.255.255.0 \
    netcfg/get_gateway=157.254.51.1 \
    netcfg/get_nameservers=\"1.1.1.1 8.8.8.8\" \
    netcfg/confirm_static=true \
    preseed/url=https://raw.githubusercontent.com/iHarmonica/tool/refs/heads/main/debian-manual-backwaves.cfg \
